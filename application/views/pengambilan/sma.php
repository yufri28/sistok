<div class="row">
    <div class="d-flex align-items-stretch">
        <div class="card w-100 p-4">
            <div class="d-flex">
                <h5 class="card-title fw-semibold mb-4">DATA PENGAMBILAN SMA</h5>
                    ...
                    <table id="table" class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-1">2</h6>
                                </td>
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-1">Semester 1</h6>
                                </td>
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-1">Baju</h6>
                                </td>
                                <td class="border-bottom-0">
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="badge bg-primary rounded-3 fw-semibold">L</span>
                                    </div>
                                </td>
                                <td class="border-bottom-0">
                                    <h6 class="fw-semibold mb-1">20241</h6>
                                </td>
                                <td class="border-bottom-0">
