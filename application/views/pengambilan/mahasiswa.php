<div class="row">
    <div class="d-flex align-items-stretch">
        <div class="card w-100 p-4">
            <div class="d-flex">
                <h5 class="card-title fw-semibold mb-4">DATA PENGAMBILAN MAHASISWA</h5>
                    ...
                    <table id="table" class="table text-nowrap mb-0 align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <h6 class="fw-semibold mb-1">IDPM<?=$pengambilan['id_pengambilan'];?></h6>
                                </td>
                                <td class="border-bottom-0">
                ...
                <div class="modal-body">
                    <div class="p-3">
                        ...
                        <div class="mb-3">
                            ...
                            <select data-control="select2" class="form-select" name="fk_mahasiswa" id="fk_mahasiswa"
                                required>
                                <option value="">Choose...</option>
